...
const options = {
  key: fs.readFileSync('/etc/letsencrypt/live/pedro-api.southafricanorth.cloudapp.azure.com/privkey.pem'),
  cert: fs.readFileSync('/etc/letsencrypt/live/pedro-api.southafricanorth.cloudapp.azure.com/fullchain.pem')
};
