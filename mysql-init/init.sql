...
INSERT INTO `periodo` VALUES (1,'07:30:00','08:30:00'),(2,'08:30:00','09:30:00'),(3,'09:30:00','10:30:00'),(4,'10:30:00','11:30:00'),(5,'11:30:00','12:30:00'),(6,'12:30:00','13:30:00'),(7,'13:30:00','14:30:00'),(8,'14:30:00','15:30:00'),(9,'15:30:00','16:30:00'),(10,'16:30:00','17:30:00'),(11,'17:30:00','18:30:00'),(12,'18:30:00','19:30:00'),(13,'19:30:00','20:30:00'),(14,'20:30:00','21:30:00'),(15,'21:30:00','22:30:00');
...
INSERT INTO `user` VALUES (1,'Administrador','admin@docente.senai.br','$2b$10$cUCNfB8zeLxEfopVSyBtIOhmUR6vtZrvIMShv.VNHqKWmiE1.AaoK','12345678909','Admin'),(2,'teste','teste@docente.senai.br','$2b$10$BSVb7srFNTSchbqdCLis1O.8z6krNgApDGNiuNCMy9Y3ZwxEcViDm','12345678901','comum'),(3,'testeAdmin','testeAdmini@docente.senai.br','$2b$10$BSVb7srFNTSchbqdCLis1O.8z6krNgApDGNiuNCMy9Y3ZwxEcViDm','01234567890','Admin');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `conflit_day` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `conflit_day`(
    IN p_dia DATE,
    IN p_fk_id_user INT,
    IN p_fk_id_sala INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `deletarUsuarioComReservas`(IN p_id_user INT)
BEGIN
...
-- Dump completed on 2025-11-24 10:33:18
